...
/* harmony import */ var _modules_scroll_smooth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scroll-smooth */ "./js/modules/scroll-smooth.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll_smooth__WEBPACK_IMPORTED_MODULE_2__["addScrollSmooth"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["saveFormInStorage"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана

  window.addEventListener('load', function () {
    Object(_modules_menu__WEBPACK_IMPORTED_MODULE_1__["openMainMenu"])();
  });
}); // ---------------------------------
...
/*!****************************!*\
  !*** ./js/modules/form.js ***!
  \****************************/
/*! exports provided: saveFormInStorage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveFormInStorage", function() { return saveFormInStorage; });
var saveFormInStorage = function saveFormInStorage() {
  var saveForm = function saveForm(form) {
    // запись в Local Starage
  ...
  var synchronizeForm = function synchronizeForm(formName) {
    // обновление данных
...
/*!****************************!*\
  !*** ./js/modules/menu.js ***!
  \****************************/
/*! exports provided: openMainMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openMainMenu", function() { return openMainMenu; });
...
var headerNavigationItem = pageHeaderNavigation.querySelectorAll('a[href*="#"]'); // закрытие меню при нажатии клавиши esc

var onEscKeydown = function onEscKeydown(evt) {
  if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["isEscapeKey"])(evt)) {
    evt.preventDefault();
    closeNavigationMenu();
  }
}; // открытие меню
...
var openNavigationMenu = function openNavigationMenu() {
...
var closeNavigationMenu = function closeNavigationMenu() {
...
var openMainMenu = function openMainMenu() {
  ...
  menuToggle.addEventListener('click', function () {
    // ...по клику на иконку бургер-меню
  ...
  document.addEventListener('click', function (evt) {
    ...
    var itsMenu = target === pageHeader || pageHeader.contains(target);
    var menuIsActive = pageHeader.classList.contains('page-header--menu-opened');
  ...
  headerNavigationItem.forEach(function (item) {
...
/*!*************************************!*\
  !*** ./js/modules/scroll-smooth.js ***!
  \*************************************/
/*! exports provided: addScrollSmooth */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addScrollSmooth", function() { return addScrollSmooth; });
var anchors = document.querySelectorAll('a[href*="#"]'); // получение якорных ссылок

var addScrollSmooth = function addScrollSmooth() {
